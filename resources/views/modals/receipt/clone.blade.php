<div id="modal_clone_receipt" class="modal fade" aria-hidden=true>
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <!-- Formulário  -->
      <form id="form-clone-receipt" data-parsley-validate="" class="form-horizontal form-label-left" action="{{ url('recibo-empresa') }}" method="POST" autocomplete="off">
