                        ...
                        <div class="x_content">
                            ...
                            <div class="col-md-6">
                                ...
                                <form id="form-edit-box" data-parsley-validate="" method="POST"
                                    action="{{ url('caixa') }}" class="form-horizontal form-label-left" novalidate="">
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input id="date_open_box" class="form-control" placeholder="dd/mm/aaaa"
                                                type="text" required="required" name="date_open"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input id="date_close_box_edit" class="date-picker form-control"
                                                placeholder="dd/mm/aaaa" type="text" name="date_close">
                                            <p class="text-muted" style="color: darkgoldenrod;">Para fechar o caixa, basta
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 offset-md-3">
                                            ...
                                            <button type="button" onClick="alterarCaixa({{ $setBox->id }})"
                                                class="btn btn-success pull-right" title="Altera e/ou fecha o caixa">
